...
describe("read smpl_cue.wav and write to a new file", function() {
    ...
    wav2.fromBuffer(fs.readFileSync(path + "/out/smpl_cue-out.wav"));
...
describe("'cue ' reading (M1F1-int12WE-AFsp-2-MARKERS-LIST) ", function() {
    ...
    let wav = new WaveFile();
    wav.fromBuffer(fs.readFileSync(path + "M1F1-int12WE-AFsp-2-MARKERS-LIST.wav"));
    let wavB = new WaveFile();
    wavB.fromBuffer(fs.readFileSync(path + "M1F1-int12WE-AFsp-2-MARKERS-LIST.wav"));
    fs.writeFileSync(
        path + "/out/M1F1-int12WE-AFsp-2-MARKERS-LIST.wav", wavB.toBuffer());
    let wav2 = new WaveFile();
    wav2.fromBuffer(fs.readFileSync(path + "/out/M1F1-int12WE-AFsp-2-MARKERS-LIST.wav"));
